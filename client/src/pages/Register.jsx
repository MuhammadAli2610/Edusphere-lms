    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div>
          ...
          <p className="text-sm" style={{ color: 'rgba(255,255,255,0.75)' }}>
            Create an account as a student or teacher and get started in minutes.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6" style={{ background: 'var(--canvas)' }}>
        <div className="w-full max-w-sm p-8 rounded-2xl border shadow-sm" style={{ borderColor: 'var(--border)', background: 'var(--surface)' }}>
          ...
          <p className="text-sm mt-1 mb-6" style={{ color: 'var(--ink-muted)' }}>Join EduSphere as a student or teacher.</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2" style={{ color: 'var(--ink-muted)' }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M4.5 20c1.5-4 5-5.5 7.5-5.5s6 1.5 7.5 5.5" stroke="currentColor" strokeWidth="1.5" />
                </svg>
              </span>
              <input
            ...
            <select
              className="border rounded-md px-3 py-2.5 text-sm focus:outline-none"
              style={{ borderColor: 'var(--border)' }}
              value={form.role}
              onFocus={e => e.target.style.borderColor = 'var(--primary)'}
              onBlur={e => e.target.style.borderColor = 'var(--border)'}
